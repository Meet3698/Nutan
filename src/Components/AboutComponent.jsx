            ...
            <div className="mainContainer">
                <div className="about">
                    <div className="text-center">
                        <img src={about1} alt="" class="img-fluid" width="100%"/>
                        <h2 style={{marginTop:'2%'}}>ABOUT US</h2>
                    </div>
                    <div className="text-center">
                    ...
                    <div style={{ marginTop: '8%' }}>
                        ...
                        <img src={impact} alt="" width="50%" class="img-fluid" style={{ float: 'left', marginRight: '2%' }} />

                        <h3>Our Vision</h3>
                        <h5 className="text-justify" style={{ lineHeight: "30px" }}>Working towards our goals on a daily basis, we envision ourselves as the world’s leading brand for Indian Ethnic Wear. Driven by customer obsession and technological prowess, we respect the divide between modern automation and the irrefutable subtleties of hand-made precision. We aspire to stay true to our core values whilst focusing on the customer and the artisan in an equal sense. Providing a flawless shopping experience through and through, we’re gradually increasing artisanal employment every single step of the way. </h5>

                    </div>
                    <div style={{marginTop:'30%'}}>
                        <div className="row">
                            <div className="column">
                                <img src={impact} class="img-fluid" alt="" />
                            </div>
                            <div className="column">
                                <img src={impact} class="img-fluid" alt="" />
                                <img src={impact} class="img-fluid" alt="" />
